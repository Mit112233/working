...
public class AttendanceDAO {
    ...
    /** 日別集計 */
    public Map<LocalDate, Long> getDailyWorkingHours(String userId) {
        return attendanceRecords.stream()
                .filter(att -> userId == null || userId.isEmpty() || att.getUserId().equals(userId))
                .filter(att -> att.getCheckInTime() != null && att.getCheckOutTime() != null)
                .collect(Collectors.groupingBy(
                        att -> att.getCheckInTime().toLocalDate(),
                        TreeMap::new,
    ...
    /** 週別集計 */
    public Map<String, Long> getWeeklyWorkingHours(String userId) {
        ...
        return attendanceRecords.stream()
                ...
                .collect(Collectors.groupingBy(
                        att -> {
                            LocalDate date = att.getCheckInTime().toLocalDate();
